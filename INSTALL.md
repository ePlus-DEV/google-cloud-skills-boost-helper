...
1. Download and unzip the `google-cloud-skills-boost-helper-{version}-chrome.zip` ([latest release](https://github.com/ePlus-DEV/google-cloud-skills-boost-helper/releases)).
