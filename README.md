...
Install from your browser's official store or use the release packages:

- [Chrome Web Store][Chrome]
- [Firefox Add-ons][Mozilla]
- [Microsoft Edge download][Edge] (GitHub Releases)
- [Opera download][Opera] (GitHub Releases)
