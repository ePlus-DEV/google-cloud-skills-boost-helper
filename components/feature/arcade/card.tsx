...
import { faArrowsRotate, faSparkles, faGear } from "@fortawesome/duotone-regular-svg-icons";
        ...
        >
            <FontAwesomeIcon
                ...
                className={`h-5 w-5 transition-transform duration-300 ${
                    isUpdating ? "animate-spin" : "hover:rotate-90"
                }`}
            />
        </button>
    );
            ...
            <div className="relative z-10 p-4">
                ...
                <div className="relative mb-6 pt-6"></div>
                    ...
                    {renderButton(
                        handleUpdatePoints,
                        faArrowsRotate,
                        "top-2 right-2 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white",
                        isUpdating
                    )}
                    ...
                    {renderButton(
                        handleOpenSettings,
                        faGear,
                        "top-2 left-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white",
                        isUpdating
                    )}
                </div>
