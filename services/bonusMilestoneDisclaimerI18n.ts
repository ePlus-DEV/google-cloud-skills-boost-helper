const DISCLAIMER_COPY: Record<string, string> = {
  ...
  zh_CN: "仅为用户自行确认。此确认仅显示在扩展程序中，并不表示 Google Cloud Skills Boost / Arcade 已验证完成情况或正式授予这些积分。",
  ...
  pt_BR: "Somente autodeclaração. Esta confirmação é exibida na extensão e não significa que o Google Cloud Skills Boost / Arcade verificou a conclusão ou concedeu oficialmente esses pontos.",
